...
const ALL_ITEMS = [
  ...
  { id: 'h2', slot: 'head', grade: 'common' },
  { id: 'h3', slot: 'head', grade: 'rare' },
  { id: 'h4', slot: 'head', grade: 'epic' },
  { id: 'h5', slot: 'head', grade: 'legend' },
  { id: 't1', slot: 'top',  grade: 'common' },
  { id: 't2', slot: 'top',  grade: 'common' },
  { id: 't3', slot: 'top',  grade: 'rare' },
  { id: 't4', slot: 'top',  grade: 'epic' },
  { id: 't5', slot: 'top',  grade: 'legend' },
  { id: 'b1', slot: 'bottom', grade: 'common' },
  { id: 'b2', slot: 'bottom', grade: 'common' },
  { id: 'b3', slot: 'bottom', grade: 'rare' },
  { id: 'b4', slot: 'bottom', grade: 'epic' },
  { id: 'b5', slot: 'bottom', grade: 'legend' },
  { id: 's1', slot: 'shoes', grade: 'common' },
  { id: 's2', slot: 'shoes', grade: 'common' },
  { id: 's3', slot: 'shoes', grade: 'rare' },
  { id: 's4', slot: 'shoes', grade: 'epic' },
  { id: 's5', slot: 'shoes', grade: 'legend' },
];
